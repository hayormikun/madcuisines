              ...
              <form onSubmit={handleSubmit} action="POST" encType="multipart/formdata" className="text-gray-700 font-semibold mx-auto w-6/12">
                ...
                <div className="lg:flex lg:justify-between my-3 overflow-hidden">
                  ...
                  <div className="grid gap-3 my-3 w-full">
                    ...
                    <input className="p-2 rounded border-2" type={"number"} id="quantity" placeholder="Extra quantity" value={quantity} onChange={(e)=> {setQuantity(e.target.valueAsNumber)}}/>
                  </div>
                </div>
                ...
                <div className="lg:flex lg:justify-between">
                  <div className="grid gap-3 w-full my-3 mr-3">
                    ...
                    <textarea className="p-3  w-full rounded border-2" id="description" placeholder="Extra description" value={description} onChange={(e)=>{setDescription(e.target.value)}} required></textarea>
                  </div>

                  <div className="grid gap-3 my-3 w-full">
                  <label htmlFor="note">Note:</label>
                    <textarea className="p-3  w-full rounded border-2" id="note" placeholder="Extra Note" value={note} onChange={(e)=>{setNote(e.target.value)}} required></textarea>
                  </div>
                </div>
